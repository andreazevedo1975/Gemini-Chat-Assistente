...
const QuickQA: React.FC = () => {
    const [prompt, setPrompt] = useState<string>('Quais são três curiosidades sobre o oceano?');
    ...
    return (
         <div className="h-full flex flex-col gap-6 max-w-3xl mx-auto">
            <div className="p-4 bg-gray-800/50 rounded-lg text-center">
                <h2 className="text-xl font-semibold text-white">Perguntas Rápidas (Baixa Latência)</h2>
                <p className="text-sm text-gray-400 mt-1">Experimente respostas rápidas para perguntas simples, impulsionado pelo gemini-flash-lite.</p>
            </div>
            <div className="bg-gray-800/50 rounded-lg p-4 flex flex-col md:flex-row gap-4 items-center">
                ...
                >
                    {isLoading ? 'Pensando...' : 'Obter Resposta'}
                </button>
            </div>
